...
set :scm, :git    #:none
set :repository, "https://github.com/nare06/nk_v3"     #"."
set :branch, "master"
...
set :push_instance_config, true       #Rubber.env != 'production'
...
namespace :deploy do
  task :app_secrets do
     #run "mkdir -p #{release_path}/config/secrets"
      transfer(:up, "config/rubber/rubber.yml", "#{release_path}/config/rubber/rubber.yml") { print “.” }
